...
import { AlignedDimensionObject } from "../scene/aligned-dimension-object";

export class DimalignedCommand implements Command {
    app: App;
    i18n: I18nService;
    type: ToolType = ToolType.DIMALIGNED;
    
    private step: number = 0;
    private points: Point[] = [];
    private previewObject: AlignedDimensionObject | null = null;
    ...
    start(preSelectedObjects?: SceneObject[]): void {
        ...
        this.reset();
        this.step = 0;
        this.app.commandLineController.setPrompt(this.i18n.t('command.dimaligned.prompt.firstPoint'));
    }
    ...
    onMouseDown(point: Point, event: MouseEvent): void {
        ...
        switch (this.step) {
            case 0:
                ...
                this.step = 1;
                this.app.commandLineController.setPrompt(this.i18n.t('command.dimaligned.prompt.secondPoint'));
                break;
            case 1:
                this.points.push(snappedPoint);
                this.app.canvasController.setPreviewLine(null);
                this.step = 2;
                this.app.commandLineController.setPrompt(this.i18n.t('command.dimaligned.prompt.dimLine'));
                break;
            case 2:
    ...
    onMouseMove(point: Point, event: MouseEvent): void {
        ...
        switch (this.step) {
            ...
            case 2:
                ...
                this.previewObject = new AlignedDimensionObject(0, p1, p2, point, styleName);
                break;
        }
        this.app.draw();
    }
