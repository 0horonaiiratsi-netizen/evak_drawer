...
import { App } from "../app";
import { ThreeDFilletTool } from "../tools/three-d-fillet-tool";
import { Command } from "./command";

export class ThreeDFilletCommand implements Command {
    app: App;
    type: any;
    private tool: ThreeDFilletTool;

    constructor(app: App) {
        this.app = app;
        this.tool = new ThreeDFilletTool(app);
    }
