...
export class EmergencyEvacuationPathTool extends Tool {
    private isDrawing = false;
    private currentPoints: Point[] = [];
    private activeSnap: SnapResult | null = null;
    
    constructor(app: App) {
        super(app, ToolType.EMERGENCY_EVACUATION_PATH);
    }
    ...
    private finalizePath(): void {
        ...
        if (this.currentPoints.length >= 2) {
            const path = new EmergencyEvacuationPath(this.app.sceneService.getNextId(), this.currentPoints);
